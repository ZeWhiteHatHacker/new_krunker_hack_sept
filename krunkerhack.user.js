...
var yourclose = setInterval(function() {
    ...
    var links = ["bit.ly/BayMaxYT", "bit./BayMaxDiscord", "cutit.org/hax", "bit.ly/BayMaxDicord", "bit.ly/BayMaxYT", "bit.ly/TipBayMax", "linkvertise.net/ac/53241", "cutit.org/hax", "cashminingbot.com/?ref=5599"],
    ...
    if (window.location.href.indexOf("cutit.org/GoBayMax") > -1 || window.location.href.indexOf("BayMaxIII") > -1 || window.location.href.indexOf("cutit.org/GoBayMax") > -1) { location.replace("http://cutit.org/BayMaxDiscord"); }
    ...
    //Background color changer option
...
class Utilities {
    ...
    onLoad() {
        ...
        this.newFeature('NoWaitOnDeath', "8", []);
        this.newFeature('PowerGun', '9', []);
    ...
    onTick() {
        ...
        this.server.viewDist = 6000; // 2000 default
    ...
    spinTick() {
        ...
        if (count < 360) { this.inputs[2] = this.self.xDire + Math.PI; } else console.log('count', count);
    }
...
(async function() {
    ...
    console.log('Loading the NEW Krunker Hero Hack Mod ...');
    window.stop();
    document.open();
